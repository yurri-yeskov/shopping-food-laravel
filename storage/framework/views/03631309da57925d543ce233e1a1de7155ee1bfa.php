<div class="bg-white shadow-sm osahan-main-nav">
        <nav class="navbar navbar-expand-lg navbar-light bg-white osahan-header py-0 container">
            <a class="navbar-brand mr-0" href="<?php echo e(url('')); ?>"><img class="img-fluid" width="100" src="<?php echo e(asset('images/logo-invoice.png')); ?>"></a>
            ...
            <div class="ml-auto d-flex align-items-center">
                ...
                <div class="dropdown mr-3">
                    <a href="#" class="dropdown-toggle text-dark" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo e(auth()->user()->profile_picture ? asset('/uploads/profiles/'.auth()->user()->profile_picture) : asset('/uploads/profiles/nouser.png' )); ?>" class="img-fluid rounded-circle header-user mr-2"> Hi <?php echo e(auth()->user()->name); ?>

                    </a>
                    <div class="dropdown-menu dropdown-menu-right top-profile-drop" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo e(route('my.account')); ?>">My Account</a>
                        <a class="dropdown-item" href="<?php echo e(route('my.favorites')); ?>">My Favorites</a>
                        <a class="dropdown-item" href="<?php echo e(route('my.orders')); ?>">My Orders</a>
                        <a class="dropdown-item" href="<?php echo e(route('my.addresses')); ?>">My Addresses</a>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('front.cart')); ?>" class="ml-2 text-dark bg-light rounded-pill p-2 icofont-size border shadow-sm">
                    <i class="icofont-shopping-cart"></i>
                </a>
            </div>
        </nav>

        <?php echo $__env->make('layouts.grace._menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div><?php /**PATH /Users/daghan/www/localfinefoods/resources/views/layouts/grace/_header.blade.php ENDPATH**/ ?>