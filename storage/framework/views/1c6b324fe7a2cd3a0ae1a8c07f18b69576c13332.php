<div class="border-bottom p-3 d-none mobile-nav">
        <div class="title d-flex align-items-center">
            <a href="home.html" class="text-decoration-none text-dark d-flex align-items-center">
                <img class="osahan-logo mr-2" src="<?php echo e(asset('front/img/logo.svg')); ?>">
                <h4 class="font-weight-bold text-success m-0">Local Fine Foods</h4>
            </a>
            <p class="ml-auto m-0">
    ...
    </div><?php /**PATH /Users/daghan/www/localfinefoods/resources/views/layouts/grace/_mobileheader.blade.php ENDPATH**/ ?>