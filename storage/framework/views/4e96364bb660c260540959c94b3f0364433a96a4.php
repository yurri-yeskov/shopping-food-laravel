                        ...
                        <div class="card-header bg-white border-0 p-0" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn d-flex align-items-center bg-white btn-block text-left btn-lg h5 px-3 py-4 m-0" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <span class="c-number">1</span> Cart (<?php echo e($items->count()); ?> items)
                                </button>
                            </h2>
                        </div>
                            ...
                            <div class="card-body p-0 border-top">
                                <div class="osahan-cart">
                                    ...
                                    <div class="cart-items bg-white position-relative border-bottom">
                                        <a href="<?php echo e(route('front.product',$item->product->id)); ?>" class="position-absolute">
                                            <span class="badge badge-danger m-3">10%</span>
                                        </a>
                                        <div class="d-flex  align-items-center p-3">
                                            <a href="<?php echo e(route('front.product',$item->product->id)); ?>"><img src="<?php echo e($item->product->productimage); ?>" class="rounded img-fluid "></a>
                                            <a href="<?php echo e(route('front.product',$item->product->id)); ?>" class="ml-3 text-dark text-decoration-none w-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <form id='myform' class="cart-items-number d-flex ml-auto" method='POST' action='#'>
                                                        ...
                                                        <input type='text' name='quantity' value='<?php echo e($item->quantity); ?>' class='qty form-control' />
                ...
                <div class="sticky_sidebar">
                    <div class="bg-white rounded overflow-hidden shadow-sm mb-3 checkout-sidebar">
                        <div class="d-flex align-items-center osahan-cart-item-profile border-bottom bg-white p-3">
                            <img alt="osahan" src="<?php echo e(auth()->user()->profileimage); ?>" class="mr-3 rounded-circle img-fluid">
                            <div class="d-flex flex-column">
                                <h6 class="mb-1 font-weight-bold"><?php echo e(auth()->user()->name); ?></h6>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.grace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/daghan/www/localfinefoods/resources/views/front/cart.blade.php ENDPATH**/ ?>