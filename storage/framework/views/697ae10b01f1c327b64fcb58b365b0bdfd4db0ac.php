                        ...
                        <div class="p-0">
                            <form action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="<?php echo e(auth()->user()->name); ?>" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="mobile_number">Mobile Number</label>
                                    <input type="number" class="form-control" id="mobile_number" value="<?php echo e(auth()->user()->mobile_number); ?>" name="mobile_number">
                                </div>
                                <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.grace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/daghan/www/localfinefoods/resources/views/front/my/account.blade.php ENDPATH**/ ?>