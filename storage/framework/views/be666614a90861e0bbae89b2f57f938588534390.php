<footer class="section-footer border-top bg-white">
    ...
    <section class="footer-bottom border-top py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <span class="pr-2">© 2020 Local Fine Foods</span>
                ...
                <div class="col-md-6 text-md-right">
                    <a href=""><img src="<?php echo e(asset('front/img/appstore.png')); ?>" height="30"></a>
                    <a href=""><img src="<?php echo e(asset('front/img/playmarket.png')); ?>" height="30"></a>
                </div>
            </div>
...
</footer><?php /**PATH /Users/daghan/www/localfinefoods/resources/views/layouts/grace/_footer.blade.php ENDPATH**/ ?>