...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('front/front/img/logo.svg')}}">
    ...
    <link href="{{asset('front/vendor/icons/icofont.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('front/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('front/vendor/sidebar/demo.css')}}" rel="stylesheet">
    @stack('header-script')
</head>
   

<body class="fixed-bottom-padding">
@include('layouts.grace._mobileheader')
@include('layouts.grace._header')
...
@include('layouts.grace._mobilemenu')
@include('layouts.grace._modal-login')
@include('layouts.grace._modal-filter')
    ...
    @include('layouts.grace._footer')

    <script src="{{asset('front/vendor/jquery/jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('front/vendor/bootstrap/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('front/vendor/slick/slick.min.js')}}" type="text/javascript" ></script>
    <script src="{{asset('front/vendor/sidebar/hc-offcanvas-nav.js')}}" type="text/javascript" ></script>
    <script src="{{asset('front/js/osahan.js')}}" type="text/javascript"></script>
