@extends('layouts.app')
@section('title', 'Area - ' . $Location->name)
@section('content')
    ...
    @include('layouts.message')
                ...
                <div class="card-body" id="editsection">
                    ...
                    </div> <br> <br> {!!Form::model($Location, array('route'=>array('editArea',request()->route('id')),'method'=>'post','files'=>true))!!}

                    <div class="card-body">

                        <div class="form-group clearfix">
                            {!!Form::label('name','Area Name')!!}<span class="required">*</span> {!!Form::text('name',null,array('class'=>'form-control','id'=>'name','placeholder'=>'Name'))!!}
                            <span class="text-danger">{!! $errors->first('name') !!}</span>
                        </div>

                        <div class="form-group clearfix">
                            {!!Form::label('name','City Name')!!}<span class="required">*</span><br>
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label text-left col-md-6">City Name:</label>
                                        <div class="col-md-6">
                                            @foreach ($Cities as $city) @if($Location->city_id==$city->id)
                                            <p class="form-control-static">
                                                {{$city->name}} </p> @endif @endforeach
