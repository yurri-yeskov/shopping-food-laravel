                ...
                <div class="col-lg-12">
                    <div class="osahan-listing">
                        <div class="d-flex align-items-center mb-3">
                            <h4>{{$category->name}} <small>{{$category->activeproducts->count()}} Products</small></h4>
                            ...
                            <div class="col-6 col-md-3 mb-3">
                                <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                    <div class="list-card-image">
                                        <a href="{{route('front.product',$product->id)}}" class="text-dark">
                                            <div class="member-plan position-absolute"><span class="badge m-3 badge-danger">10%</span></div>
                                            <div class="p-3">
                                                <img src="{{$product->productimage}}" class="img-fluid item-img w-100 mb-3 rounded">
                                                <h6>{{$product->name}}</h6>
                                                <div class="d-flex align-items-center">
                                                    <h6 class="price m-0 text-success">$0.8/kg</h6>
                                                    <a data-toggle="collapse" href="#product{{$product->id}}" role="button" aria-expanded="false" aria-controls="product{{$product->id}}" class="btn btn-success btn-sm ml-auto">+</a>
                                                    <div class="collapse qty_show" id="product{{$product->id}}">
                                                        <div>
