    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <p style="font-weight: bold; font-size: 18px; margin-top: 60px;">Dear, {{$data->name}},</p>
                        <p style="font-size: 16px;color: #5f5e5e;line-height: 1.5;margin-top: 10px;">Thank you for signing up with LocalFineFoods</p>
                    </td>
                </tr>
